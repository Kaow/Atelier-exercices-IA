...
public class UserServiceTest {
  ...
  public void testGetUserName_UserExists() {
    // Arrange
    Long userId = 1L;
    User user = new User(userId, "John Doe", "0606060606", "", RoleEnum.USER, "11/10/1997");
  ...
  @Test
  public void testCreateNewUser_InvalidMail() {
    // TODO :: test to write
    // Behavior if a user has used an invalid mail address
  }
